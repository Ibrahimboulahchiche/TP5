...
| --------------------------------------------- | :------: | :--------: |
| Implémentation des services du serveur        |    5.5     |     6      |
...
playlistService.js : getPlaylistById() utiliser .findOne()

Prioriser l'utilisation des opération ternaires au lieu de if-else dans le serveur

playlist.jsx: Il faut utiliser dans le HTML le component Song.jsx
